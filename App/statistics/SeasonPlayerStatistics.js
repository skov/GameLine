...
class SeasonPlayerStatistics extends Component {
  constructor(props){
  super(props);
  this.state = {
    gameList:[],
...
async componentWillMount(){
  try {
    ...
    Database.listenSeasonPlayerStats(user.uid, this.props.team, this.props.season, this.props.homeOpp, this.props.player, (list) => {
      gameList = list;
    });
...
render() {
  ...
  return (
    <ImageBackground source={require('../images/background.jpg')} style={styles.container}>
      <TopMenu backButton={'true'} title={'SEASON PLAYER STATISTICS'}/>
      ...
      <View style={styles.headingView}>
        ...
        <TouchableOpacity onPress={() => {
          Alert.alert(
            'Game List',
            'This is a list of games this player has played during the selected season.',
        ...
        <FlatList
          ...
          onPress = {()=>{
            Actions.gamePlayerStatistics({ team: this.props.team, season:this.props.season, homeOpp: this.props.homeOpp, player: this.props.player, game:item._key})
          }}>
...
export default SeasonPlayerStatistics;
